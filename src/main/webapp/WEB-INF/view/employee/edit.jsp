                ...
                <div class="col-8">
                    <form action="${pageContext.request.contextPath}/employee?action=edit" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="${employee.name}" placeholder="Name"
                                   required><br><br>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="email" name="email" value="${employee.email}" placeholder="Email"
                                   required><br><br>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="salary" name="salary" value="${employee.salary}" placeholder="Salary"
                                   required><br><br>
                        </div>
