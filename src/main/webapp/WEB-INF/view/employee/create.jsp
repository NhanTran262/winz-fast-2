                ...
                <div class="col-8">
                    <form action="${pageContext.request.contextPath}/employee?action=create" method="post">
                        ...
                        <div>
                            ...
                            <input type="date" id="dateOfBirth" name="dateOfBirth" placeholder="Date Of Birth" required><br><br>
                        </div>
                        <div>
                            <label for="idCard">Id Card:</label>
                            <input type="text" id="idCard" name="idCard" placeholder="Id Card" required><br><br>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="employeeAddress" name="employeeAddress" placeholder="Address"
                                   required><br><br>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="levelId">Level:</label>
                            <select name="levelId" id="levelId" class="form-select" aria-label="Default select example"
                    ...
                    <form action="${pageContext.request.contextPath}/employee">
                        ...
                        <button type="submit" value="employee">Back</button>
                    </form>
                </div>
                <div class="col-2"></div>
            </div>
