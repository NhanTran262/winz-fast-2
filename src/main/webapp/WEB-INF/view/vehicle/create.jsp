...
<%@ page import="com.example.winz_fast.model.product.Variant" %>
    ...
    <div class="main">
        ...
        <section class="content">
            ...
            <div class="container">
                <div class="col-2"></div>
                <div class="col-8">
                    <form action="${pageContext.request.contextPath}/vehicle?action=create" method="post">
                        <div>
                            <label for="vehicle_name">Name:</label>
                            <input type="text" id="vehicle_name" name="vehicle_name" placeholder="Name"
                                   required><br><br>
                        </div>
